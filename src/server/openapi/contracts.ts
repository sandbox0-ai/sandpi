...
export const openApiRouteContracts: readonly OpenApiRouteContract[] = [
  ...
  defineContract({
    method: "POST",
    url: "/api/v1/environments/:environmentId/previews",
    schema: {
      operationId: "createEnvironmentPreview",
      summary: "Open a private preview for a Sandbox loopback URL",
      tags: ["Environment previews"],
      body: environmentPreviewCreateSchema,
      response: { 201: dataEnvelope(environmentPreviewGrantSchema) },
    },
  }),
  defineContract({
    method: "PUT",
    url: "/api/v1/environments/:environmentId/previews/:previewId",
    schema: {
      operationId: "renewEnvironmentPreview",
      summary: "Renew a private Environment preview",
      tags: ["Environment previews"],
      body: environmentPreviewRenewSchema,
      response: { 200: dataEnvelope(environmentPreviewGrantSchema) },
    },
  }),
  defineContract({
    method: "DELETE",
    url: "/api/v1/environments/:environmentId/previews/:previewId",
    schema: {
      operationId: "revokeEnvironmentPreview",
      summary: "Revoke a private Environment preview",
      tags: ["Environment previews"],
      response: { 200: dataEnvelope(idResultSchema) },
    },
  }),
