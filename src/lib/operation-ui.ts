...
const copy = {
  en: {
    ...
    guest: {
      ...
      emptySidebar: "Log in to load your Environments.",
      expandSidebar: "Expand sidebar",
      openNavigation: "Open navigation",
      newSession: "Environment terminal",
      ready: "Gateway online",
      question: "Native coding-agent terminals, anywhere.",
      introduction:
        "One persistent Sandbox per Environment. Reconnect from web, desktop, or mobile without replacing the agent's native TUI.",
      persistentWorkspace: "Persistent Environment",
      secureSandbox: "Secure Sandbox",
      backgroundWork: "Native TUI",
      placeholder: "Attach to an Environment…",
      signedOut: "Authentication required",
      send: "Log in and open an Environment",
      starterLabel: "Supported agents",
      starters: ["Codex", "Claude Code", "Pi"],
    },
    helpFeedback: {
      eyebrow: "Support",
      title: "Help & feedback",
      ...
      documentationDescription:
        "Learn how Environments, native agent terminals, Sandboxes, Skills, and MCP work.",
    ...
    inspector: {
      ...
      previewLoading: "Opening private Sandbox preview…",
      previewReload: "Reload preview",
      previewOpenNewTab: "Open preview in a new tab",
      previewEmpty: "Click a localhost, 127.0.0.1, or [::1] link from the conversation or terminal to preview it here.",
      previewFrame: "Sandbox preview",
      lastHour: "Last hour",
  ...
  "zh-CN": {
    ...
    guest: {
      ...
      emptySidebar: "登录后加载你的环境。",
      expandSidebar: "展开侧边栏",
      openNavigation: "打开导航",
      newSession: "环境终端",
      ready: "网关在线",
      question: "随处连接原生 coding-agent 终端。",
      introduction:
        "每个环境对应一个持久 Sandbox，可从网页、桌面或移动端重连，并保留 agent 的原生 TUI。",
      persistentWorkspace: "持久环境",
      secureSandbox: "安全 Sandbox",
      backgroundWork: "原生 TUI",
      placeholder: "连接到一个环境…",
      signedOut: "需要登录",
      send: "登录并打开环境",
      starterLabel: "支持的 agent",
      starters: ["Codex", "Claude Code", "Pi"],
    },
    helpFeedback: {
      eyebrow: "支持",
      ...
      documentation: "查看文档",
      documentationDescription:
        "了解环境、原生 agent 终端、Sandbox、Skills 和 MCP 的工作方式。",
      reportBug: "报告问题",
    ...
    inspector: {
      ...
      previewLoading: "正在打开私有 Sandbox 预览…",
      previewReload: "重新加载预览",
      previewOpenNewTab: "在新标签页打开预览",
      previewEmpty: "点击对话或终端中的 localhost / 127.0.0.1 / [::1] 链接，即可在这里预览。",
      previewFrame: "Sandbox 预览",
      lastHour: "最近一小时",
