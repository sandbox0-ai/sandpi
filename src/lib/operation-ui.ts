...
const copy = {
  en: {
    ...
    inspector: {
      ...
      browserStarting: "Starting this Session’s browser page…",
      browserUnavailable:
        "This Session’s browser page did not become ready. Retry after the Environment finishes resuming.",
      browserRetry: "Retry",
  ...
  "zh-CN": {
    ...
    inspector: {
      ...
      browserTitle: "Session 浏览器",
      browserStarting: "正在启动当前 Session 的浏览器页面…",
      browserUnavailable:
        "当前 Session 的浏览器页面未能就绪，请等待 Environment 恢复完成后重试。",
      browserRetry: "重试",
      browserLoading: "正在加载…",
