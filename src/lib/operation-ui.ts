...
const copy = {
  en: {
    sidebar: {
      ...
      completionUpdateFailed: "Could not update completion. Try again.",
      rename: "Rename",
      archive: "Archive",
    ...
    inspector: {
      ...
      previewAddress: "Local Preview address",
      previewOpen: "Open Preview",
      previewReload: "Reload Preview",
      previewOpenNewTab: "Open Preview in a new tab",
      previewEmpty:
        "Enter an HTTP address on localhost or 127.0.0.1, or open one from the conversation.",
      previewLoading: "Loading Preview…",
      previewInvalid:
        "Preview URLs must use HTTP on localhost or 127.0.0.1.",
      previewUnavailable:
        "Preview is unavailable. Check that the local service is running and retry.",
  ...
  "zh-CN": {
    sidebar: {
      ...
      markComplete: "标记完成",
      markIncomplete: "取消完成",
      completionUpdateFailed: "无法更新完成状态，请重试。",
      rename: "重命名",
      archive: "归档",
      preferences: "偏好设置",
      help: "帮助与反馈",
    ...
    inspector: {
      ...
      previewTitle: "Environment Preview",
      previewAddress: "本地 Preview 地址",
      previewOpen: "打开 Preview",
      previewReload: "重新加载 Preview",
      previewOpenNewTab: "在新标签页打开 Preview",
      previewEmpty:
        "输入 localhost 或 127.0.0.1 上的 HTTP 地址，也可以从对话中直接打开。",
      previewLoading: "正在加载 Preview…",
      previewInvalid:
        "Preview 仅支持 localhost 或 127.0.0.1 上的 HTTP 地址。",
      previewUnavailable:
        "Preview 暂不可用，请确认本地服务正在运行后重试。",
